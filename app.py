...
with st.sidebar:
    ...
    st.markdown("---")
    st.caption("💡 Complete your profile for personalized coaching")
...
if player_name:
    st.info(f"👋 Welcome, **{player_name}**! | Age: {age} | Level: {skill_level} | Goal: {training_goal}")
...
if api_key:
    try:
        ...
        st.success("✅ Gemini 1.5 Pro Model Configured Successfully!")
    except Exception as e:
        st.error(f"❌ Error configuring API: {str(e)}")
else:
    st.warning("⚠️ Please enter your Gemini 1.5 Pro API Key in the sidebar to activate CoachBot")
...
def generate_coaching_advice(prompt_template, user_data, temperature=0.3, feature_name=""):
    ...
    """
    if not api_key:
        return "⚠️ Please configure your Gemini API key in the sidebar first."
...
PROMPTS = {
    "position_workout": {
        "name": "🎯 Position-Specific Workout Plan",
        "temperature": 0.3,
...
"""
    ...
    "injury_recovery": {
        "name": "🏥 Safe Injury Recovery Training",
        "temperature": 0.3,
...
"""
    ...
    "tactical_strategy": {
        "name": "🧠 Tactical Coaching & Game Strategy",
        "temperature": 0.7,
...
"""
    ...
    "nutrition_guide": {
        "name": "🥗 Personalized Nutrition & Hydration",
        "temperature": 0.3,
...
"""
    ...
    "mental_training": {
        "name": "🧘 Mental Toughness & Sports Psychology",
        "temperature": 0.7,
...
"""
    ...
    "serve_optimization": {
        "name": "⚡ Serve Technique & Power Development",
        "temperature": 0.3,
...
"""
    ...
    "footwork_agility": {
        "name": "👟 Footwork & Movement Training",
        "temperature": 0.3,
...
"""
    ...
    "match_analysis": {
        "name": "📊 Performance Analysis & Match Stats",
        "temperature": 0.3,
...
"""
    ...
    "tournament_prep": {
        "name": "🏆 Tournament Preparation Protocol",
        "temperature": 0.7,
...
# ============================================================================
st.markdown("---")
st.markdown("### 🚀 Select Your Coaching Feature")
...
if st.session_state.current_response:
    ...
    if st.session_state.show_schedule:
        st.markdown("---")
        st.markdown("### 📅 Recommended Weekly Training Schedule")
    ...
    if st.session_state.show_nutrition:
        st.markdown("---")
        st.markdown("### 🍽️ Sample Daily Nutrition Plan")
...
with st.expander("🎓 Assignment Information"):
    st.markdown("""
...
with st.expander("⚠️ Disclaimer & Safety"):
    st.markdown("""
    **Important Safety Information:**
    
    ⚠️ **Medical Disclaimer:** CoachBot AI provides general fitness and training guidance based on AI-generated recommendations. 
...
st.markdown("""
    <div style='text-align: center; color: #64748B; padding: 2rem 0;'>
        ...
        <p style='font-size: 0.95rem;'>🎾 Powered by Google Gemini 1.5 Pro | Built with Streamlit</p>
